...
**When NOT to use:**
- For gradual internationalization process -> use skill-grad-uppsala
- For early-stage rapid internationalization -> use skill-grad-born-global
- For national competitive advantage analysis -> use skill-grad-diamond
