...
**When NOT to use:**
- For firms that internationalize rapidly from inception -> use skill-grad-born-global
- For FDI mode selection (OLI-based) -> use skill-grad-oli
- For national competitive advantage assessment -> use skill-grad-diamond
