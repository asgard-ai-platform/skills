...
Key assumptions:
1. Consciousness is always consciousness OF something (intentionality)
2. Lived experience has an essential structure that can be described
3. The researcher must suspend the natural attitude through epoche (bracketing)
4. Meaning is constituted through the relationship between person and phenomenon
