...
**When NOT to use:**
- For analyzing disruption from external entrants -> use skill-grad-disruptive-innovation
- For strategic alliances to access innovation -> use skill-grad-coopetition
- For internationalization decisions -> use skill-grad-oli or skill-grad-uppsala
