---
name: "skill-grad-disruptive-innovation"
...
- For platform-based competition -> use skill-grad-platform-economics
- For analyzing national-level innovation systems -> use skill-grad-diamond
