...
metadata:
  ...
  tags: ["coopetition", "value-net", "brandenburger-nalebuff", "PARTS-framework", "complementors", "game-theory-strategy"]
---
...
- For internal organizational balance -> use skill-grad-ambidexterity
- For international market entry mode -> use skill-grad-oli
