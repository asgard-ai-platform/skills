...
**When NOT to use:**
- For established firms expanding gradually -> use skill-grad-uppsala
- For FDI mode choice for large multinationals -> use skill-grad-oli
- For industry-level competitive advantage -> use skill-grad-diamond
