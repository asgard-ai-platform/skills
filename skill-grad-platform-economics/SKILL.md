---
name: "skill-grad-platform-economics"
...
- For competitive dynamics between platforms -> use skill-grad-coopetition
- For innovation strategy within platforms -> use skill-grad-ambidexterity
