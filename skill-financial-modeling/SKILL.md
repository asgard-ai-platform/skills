...
metadata:
  category: "WP-08 財務投資"
  tags: ["finance", "financial-modeling", "forecasting", "three-statement"]
---
...
- For DCF valuation built on the three-statement model, see the skill-biz-dcf skill
