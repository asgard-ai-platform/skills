...
11. Register for e-invoice if B2C (see skill-tw-einvoice-guide)
...
- For tax obligations after registration, see the skill-tw-tax-basics skill
- For e-invoice setup, see the skill-tw-einvoice-guide skill
